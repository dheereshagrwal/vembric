...
export const metadata = {
  ...
  description:
    'Learn everything there is to know about the Vembric API and integrate Vembric into your product.',
}
...
Use the Vembric API to access contacts, conversations, group messages, and more and seamlessly integrate your product into the workflows of dozens of devoted Vembric users. {{ className: 'lead' }}
